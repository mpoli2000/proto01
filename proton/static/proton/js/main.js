...
document.addEventListener('DOMContentLoaded', () => {
  ...
  /**
   * Scroll top button
   * [martin] toggleScrollTop(): This function is responsible for toggling the visibility of a scroll-to-top button.
   * If the scrollTop element exists and the window has scrolled down more than 100 pixels, it adds the "active" class to the scrollTop element;
   * otherwise, it removes the "active" class.
   * Event listener for the click event on the scrollTop element: When the scroll-to-top button is clicked,
...
function toggleScrollTop() {
  ...
  /**
   * Preloader:
   * [martin] preloader removal: This section removes the preloader element from the page when the window has finished loading.
   */
